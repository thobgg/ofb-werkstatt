"""HTML der Korrekturmaske. Ausgelagert, damit maske.py lesbar bleibt."""

SEITE = r"""<!doctype html><html lang=de><head><meta charset=utf-8>
<meta name=viewport content="width=device-width,initial-scale=1">
<title>Erfassung Haberschlacht</title><style>
...
<header><b>Erfassung</b><span class=zaehler id=z></span>
